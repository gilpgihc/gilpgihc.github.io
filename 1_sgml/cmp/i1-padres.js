...
export class I1Padres extends Diapositiva {
 /** @override */
 connectedCallback() {
  super.connectedCallback();
  this.innerHTML = /* html */
   `<h1>I. Elementos padres</h1>
   <div class="lectura">
    <ul>
     <li>
      <p>
       Un elemento es
       <dfn>padre</dfn>
       de todos los textos, comentarios, y elementos que formen parte de su
       contenido.
      </p>
     </li>
   </ul>
   ...
   <div><span
      style="color: #008000;">&nbsp;El&nbsp;elemento&nbsp;html&nbsp;es&nbsp;padre&nbsp;de&nbsp;los</span>
   </div>
   <div><span
      style="color: #008000;">&nbsp;elementos&nbsp;head&nbsp;y&nbsp;body.</span>
   </div>
   <div><span style="color: #008000;">--&gt;</span></div>
   ...
   <div><span style="color: #008000;">&lt;!--</span></div>
   <div><span
      style="color: #008000;">&nbsp;El&nbsp;elemento&nbsp;head&nbsp;es&nbsp;padre&nbsp;de&nbsp;los</span>
   </div>
   <div><span
      style="color: #008000;">&nbsp;2&nbsp;elementos&nbsp;meta&nbsp;y&nbsp;del&nbsp;title.</span>
   </div>
   <div><span style="color: #008000;">--&gt;</span></div>
...
customElements.define("i1-padres", I1Padres);