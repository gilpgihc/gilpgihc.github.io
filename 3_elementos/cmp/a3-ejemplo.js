...
export class A3Ejemplo extends Diapositiva {
 /** @override */
 connectedCallback() {
  super.connectedCallback();
  this.innerHTML = /* html */
   `<h1>A. Ejemplo típico</h1>
   <div class="lectura">
    <p>
  ...
  <div class="horizontal">
   ...
   <div>&nbsp;&nbsp;&nbsp;<span style="color: #ff0000;">content</span>=<span
      ...
      style="color: #800000;">&gt;</span></div>
   <div>&nbsp;<span
      style="color: #800000;">&lt;title&gt;</span>🏡Estructura<span
...
customElements.define("a3-ejemplo", A3Ejemplo);